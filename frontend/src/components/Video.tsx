          ...
          <div className="flex items-start gap-16">
            <div className="flex-1">
              ...
              <p className="mt-4 text-gray-200 leading-relaxed">
                ...
                Vite e TailwindCSS. Vamos também realizar o setup do nosso projeto no GraphCMS criando as entidades da aplicação 
              ...
              <div className="flex items-end gap-4 mt-6">
                <img 
                  ...
                  src="https://i.pinimg.com/originals/1f/4f/b4/1f4fb47e89b60da1da8618926f7cb578.jpg" 
                  alt="avatar"
                />

                <div className="leading-relaxed">
                  <strong className="font-bold text-2xl block">Professor </strong>
